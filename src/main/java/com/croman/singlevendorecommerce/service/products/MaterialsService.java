...
public class MaterialsService {
	...
	public PageResponse<MaterialDTO> getMaterials(String languageName, int page, int size, String term) {
		...
		if (!languageName.equals(LocaleUtils.DATABASE_DEFAULT_LANG)) {
			List<Long> materialIds = allMaterials.stream().map(Material::getMaterialId).distinct().toList();
	...
	public void updateMaterial(Long materialId, UpdateMaterialDTO updateMaterialDTO) {
		...
		updateEnglishName(material, englishName);
	...
	private void updateEnglishName(Material material, String englishName) {
		Optional<Material> existingMaterialOptional = materialRepository.findByName(englishName);
