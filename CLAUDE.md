...
1. **Flyway**: never edit existing `V<n>__*.sql` files — always create a new one. Current high-water mark: **V28** (`V28__add_slugs_and_slug_history`). Next migration is **V29** (`verification_codes`, email verification — in progress).
